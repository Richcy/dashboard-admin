                ...
                <form action="{{ route('jabatan-pegawai.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('jenjang_jabatan') is-invalid @enderror" id="jenjang_jabatan" name="jenjang_jabatan" value="{{ old('jenjang_jabatan') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('golongan_pangkat') is-invalid @enderror" id="golongan_pangkat" name="golongan_pangkat" value="{{ old('golongan_pangkat') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tmt_jabatan') is-invalid @enderror" id="tmt_jabatan" name="tmt_jabatan" value="{{ old('tmt_jabatan') }}">
                            @error('tmt_jabatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('status_jabatan') is-invalid @enderror" id="status_jabatan" name="status_jabatan">
                                ...
                                <option value="utama" {{ old('status_jabatan') == 'utama' ? 'selected' : '' }}>Utama</option>
                                <option value="tambahan" {{ old('status_jabatan') == 'tambahan' ? 'selected' : '' }}>Tambahan</option>
                            </select>
