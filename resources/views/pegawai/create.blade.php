                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('jenis_tenaga') is-invalid @enderror" id="jenis_tenaga" name="jenis_tenaga">
                                ...
                                <option value="nakes" {{ old('jenis_tenaga') == 'nakes' ? 'selected' : '' }}>Tenaga Kesehatan</option>
                                <option value="non_nakes" {{ old('jenis_tenaga') == 'non_nakes' ? 'selected' : '' }}>Tenaga Non-Kesehatan</option>
                            </select>
                            @error('jenis_tenaga')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('posisi_jabatan') is-invalid @enderror" id="posisi_jabatan" name="posisi_jabatan">
                                ...
                                <option value="struktural" {{ old('posisi_jabatan') == 'struktural' ? 'selected' : '' }}>Struktural</option>
                                <option value="jabfung" {{ old('posisi_jabatan') == 'jabfung' ? 'selected' : '' }}>Jabatan Fungsional</option>
                                <option value="pelaksana" {{ old('posisi_jabatan') == 'pelaksana' ? 'selected' : '' }}>Pelaksana</option>
                                <option value="honorer" {{ old('posisi_jabatan') == 'honorer' ? 'selected' : '' }}>Honorer</option>
                            </select>
